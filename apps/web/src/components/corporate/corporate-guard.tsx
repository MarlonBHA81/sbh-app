...
/**
 * Renders the corporate portal only when the active profile is a corporate.
 * Otherwise it explains the portal and offers the account switcher, mirroring
 * how the rest of the app nudges profile-scoped features.
 */
