    ...
    public static function generate(string $lastUserMessage): string
    {
        ...
        $tip = match (true) {
            ...
            self::mentions($text, ['customer', 'clients', 'sales', 'sell', 'leads', 'market']) =>
                "To win customers, start with people who already trust you. List 20 people who know you, tell each one exactly what you offer and who it helps, then ask for a referral after every job. Word of mouth beats a big ad budget when you're small.",
            self::mentions($text, ['funding', 'loan', 'grant', 'capital', 'money', 'cash flow', 'cashflow']) =>
                "For funding, first make sure your numbers are clear: a simple month-by-month cash-flow view of money in vs money out. That same view is what lenders and grant panels want to see. Check the Opportunities feed for grants and tenders you can apply to.",
            self::mentions($text, ['staff', 'hire', 'hiring', 'employee', 'team']) =>
                "Before hiring, write down the exact tasks you want off your plate and how many hours they take. Hire for that specific gap, start part-time if you can, and get the contract and UIF paperwork right from day one.",
            self::mentions($text, ['marketing', 'social', 'instagram', 'facebook', 'whatsapp', 'brand']) =>
                "Keep marketing simple and consistent: pick one channel your customers actually use, post something useful two or three times a week, and always include a clear next step (a WhatsApp number, a link, a visit). Consistency matters more than perfection.",
            default =>
                "A good next step is to name the single biggest thing holding your business back right now, then break it into one small action you can take this week. Small, steady steps compound faster than big plans that never start.",
        };
